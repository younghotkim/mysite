				...
				<div id="user">
					<div id="joinForm">
						<form action="./user" method="get">
							...
							<!-- 성별 -->
							<div class="form-group">
								<span class="form-text">성별</span> <label for="rdo-male">남</label> <input type="radio" id="rdo-male" name="sex" value="male"> <label
									for="rdo-female">여</label> <input type="radio" id="rdo-female" name="sex" value="female">
